...
let defaultSetting = {
    ...
    'block_selectors': ['*[style*="background"]', '*[style*="display"]','*[style*="opacity"]','*[style*="margin: 0px"]', '*[style*="padding: 0px"]'],
