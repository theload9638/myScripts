...
let styleStr = '<style>.GoogleActiveViewInnerContainer,.google-auto-placed,.adsbygoogle,.adsbygoogle-noablate{display:none !important;} * {background:#9c9999 !important;} .reading{ padding: 0px !important;}</style>';
