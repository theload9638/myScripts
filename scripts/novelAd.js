...
let defaultSetting = {
    ...
    'scroll_delay': 2000,
    'block_times': 50,
    'block_target':['IMG','VIDEO','IFRAME','OBJECT','EMBED','AUDIO','PICTURE','SOURCE','SVG','IMAGE','FRAME','INS','*[style*="opacity"]','*[style*="background"]','*[style*="z-index"]','*[style*="display"]','*[style*="margin: 0px"]','*[style*="padding: 0px"]'],
...
if ($response.statusCode === 200 && (url.includes('html') || (type && type.includes("text")))) {
    ...
    let domains = [
        ...
        '789free.fun',
        'www.missai.vip',
        'aplsof2fd.kyrvrybhsovashordoblarmek.com',
        '8tlzg5.com',
        'txmz0y.com',
        'lzicw0.com',
