    ...
    try {
        ...
        if (/utf-?8/i.test(charset)) {
            ...
            if (/^https?:\/\/hlib\.cc/.test(url)) {
                ...
                styleStr += '.slide,img,picture,.Qtqi{display:none !important;pointer-events: none !important;}';
