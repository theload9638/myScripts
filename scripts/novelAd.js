...
function calcQWStyle() {
    let size = 5;
    let tmpStr = ".qx-qw{all:initial;--size:50px;--itemSize:38px;background:transparent !important;border-radius:50%;position:fixed;z-index:9999;top:50%;transform:translateY(-50%);width:var(--size);height:var(--size);display:flex;justify-content:center;align-items:center}.qx-qw-left{left:4px;right:'auto'}.qx-qw-right{right:4px;left:'auto'}";
