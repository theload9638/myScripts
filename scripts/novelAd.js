...
function applyFloatyW(html) {
    ...
    let cn = '<div class="qx-qw qx-qw-right"><div class="qx-main"><span>QX</span></div><div class="qx-btn qx-btn-prv"><span>上页</span></div><div class="qx-btn qx-btn-ai"><span>AI</span></div><div class="qx-btn qx-btn-close"><span>关闭</span></div><div class="qx-btn qx-btn-dir"><span>目录</span></div><div class="qx-btn qx-btn-nxt"><span>下页</span></div></div>';
...
function calcQWStyle() {
    ...
    tmpStr +=".qx-fw-ai-mask{display:none;position:fixed;left:0;top:0;right:0;bottom:0;background:rgba(0,0,0,0.5);z-index:10000;align-items:center;justify-content:center}.qx-fw-ai-mask.qx-fw-ai--show{display:flex}.qx-fw-ai-box{width:90%;max-width:400px;max-height:75vh;background:#fff;border-radius:12px;box-shadow:0 8px 32px rgba(0,0,0,0.2);display:flex;flex-direction:column;overflow:hidden}";
    tmpStr +=".qx-fw-ai-head{padding:12px 16px;border-bottom:1px solid #eee;display:flex;align-items:center;justify-content:space-between;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%) !important;color:#fff !important}.qx-fw-ai-head h3{margin:0;font-size:16px;font-weight:600;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.qx-fw-ai-close{width:28px;height:28px;border:none;background:rgba(255,255,255,0.3);color:#fff;border-radius:50%;cursor:pointer;font-size:18px;line-height:1;padding:0}";
    ...
    tmpStr +=".qx-fw-ai-input:focus{outline:none;border-color:#667eea}.qx-fw-ai-send{align-self:flex-end;padding:8px 20px;border:none;border-radius:8px;background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);color:#fff;font-size:14px;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.qx-fw-ai-send:hover{opacity:0.9}";
