...
function applyFloatyW(html) {
    ...
    let sty = `.qx-fw{position:fixed;right:6px;top:60%;transform:translateY(-40%);z-index:9999;display:flex;flex-direction:column;align-items:center;gap:8px;}.qx-fw .qx-fw__main,.qx-fw .qx-fw__btn{border-radius:50%;background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important;color:#fff;display:flex;align-items:center;justify-content:center;transition: transform 0.2s ease,box-shadow 0.2s ease;user-select:none;overflow: hidden;clip-path: circle(50%);-webkit-clip-path: circle(50%);}.qx-fw .qx-fw__main{position:relative;width:50px;height:50px;font-size:14px;box-shadow: 0 4px 20px rgba(102, 126, 234, 0.4);}.qx-fw .qx-fw__main:hover{transform: scale(1.08);box-shadow: 0 6px 28px rgba(102, 126, 234, 0.5);}.qx-fw .qx-fw__main .qx-fw__icon{ line-height: 1; pointer-events: none; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);-webkit-background-clip: text;background-clip: text;color: #b3adad;}.qx-fw .qx-fw__btn {display:none;width:40px;height:40px;padding:0;border:none;font-size:10px;line-height:1.2;box-shadow: 0 2px 10px rgba(102, 126, 234, 0.35);}.qx-fw.qx-fw--open .qx-fw__btn{ display: flex; }.qx-fw .qx-fw__btn:hover { opacity: 0.95; transform: scale(1.05); }.qx-fw .qx-fw__main:active,.qx-fw .qx-fw__btn:active { transform: scale(0.98); }.qx-fw .qx-fw__btn--prev { order: 1; }.qx-fw .qx-fw__main { order: 2; }.qx-fw .qx-fw__btn--next { order: 3; }`;
